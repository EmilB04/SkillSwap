                    ...
                    <div className="flex flex-col md:flex-row items-center md:items-start gap-6">
                        ...
                        <figure className="flex-shrink-0">
                            {userData.profileImage ? (
                                ...
                                <div className="w-32 h-32 rounded-full bg-primary border-4 border-primary-light flex items-center justify-center text-4xl font-bold text-white">
                        ...
                        <a
                            href="/profile/edit"
                            className="px-6 py-2 rounded-lg bg-primary hover:bg-primary-hover text-white font-medium border-2 border-primary hover:border-primary-hover transition-colors duration-[280ms] whitespace-nowrap"
                        >
                            Edit Profile
                        </a>
                    </div>
                    ...
                    <section className="bg-white rounded-lg shadow-md p-6" aria-labelledby="skills-learning-heading">
                        ...
                        <div className="flex flex-wrap gap-2">
                            {userData.skillsLearning.map((skill, index) => (
                                <span 
                                    key={index}
                                    className="px-4 py-2 rounded-full border-2 border-primary text-primary text-sm font-medium"
                                >
                                    {skill}
                                </span>
                            ))}
